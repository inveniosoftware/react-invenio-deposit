...
export class SubmitReviewButtonComponent extends Component {
  ...
  render() {
    const { actionState, SubmitReviewClick, numberOfFiles, ...uiProps } =
      this.props;

    const { isConfirmModalOpen } = this.state;

    const action = i18next.t('submit review');
